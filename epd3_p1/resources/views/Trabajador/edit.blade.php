...
<head>
    <meta charset="UTF-8">
    <title>Edit Trabajador Form </title>
...
<body>
    <div class="container mt-2">
        <div class="row">
            <div class="col-lg-12 margin-tb">
                ...
                <div class="pull-right">
                    <a class="btn btn-primary" href="{{ route('Trabajador.index') }}" enctype="multipart/form-data">
                        Back</a>
                </div>
            </div>
        </div>
        ...
        @endif
        <form action="{{ route('Trabajador.update',$Trabajador->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
